...
class StarterSite extends Timber\Site {
    ...
    public function register_assets(){
        ...
        wp_enqueue_style('my-font', '//db.onlinewebfonts.com/c/12f5ed934c31c5e400c733ea7fe58cb3?family=SF+UI+Display+Bold', array(), 1.0);
        wp_enqueue_style('my-font-second', '//db.onlinewebfonts.com/c/19d93ed94fcde59d609dd56bb0f1e9f0?family=SF+UI+Display+Light', array(), 1.0);
        wp_enqueue_style('my-font-third', '//db.onlinewebfonts.com/c/499a9b7e46661c79fd3aa2542cbdc440?family=SF+UI+Display+Medium', array(), 1.0);
    }
